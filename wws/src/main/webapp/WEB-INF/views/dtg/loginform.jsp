...
<div id='return_btn'><%@ include file="return_btn.jsp"%></div>
 <div style='width:723px;margin:0 auto;' >
            ...
            function open_popup1(){
            	var url = "${pageContext.request.contextPath}/dtg/findId.do";
            ...
            function open_popup2(){
            	var url = "${pageContext.request.contextPath}/dtg/resetPw.do";
            ...
            function open_popup3(){
            	var url = "${pageContext.request.contextPath}/dtg/join.do";
           ...
           $(document).ready(function(){
            	$('#btn').click(function(){
            		$.ajax('${pageContext.request.contextPath}/dtg/login.do',{
            			type:'POST',
                		dataType:'json',
                		data:{
                			id : $('#id').val(),
