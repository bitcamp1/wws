	...
	<tr height="26">
		...
		<td class="subtitle_etc">
            <select name="sitem">
            	...
            	<option value="cell">휴대번호</option></select>
            ...
            <input id='btn_regi' type="button" value=" 설치팀등록 " class="button02 h25">
		</td>
	</tr>
</table>
<script>
$(function(){
	$('#btn_regi').click(function(){window.open('${pageContext.request.contextPath}/dtg/oper_regi.do','popup','width=700,height=400');});
});
