...
<style>
	...
	#gsretail_slider{width:1028px;margin:0 auto;}
	
</style>

    
		        <ul class="bjqs">
			         <li><img src="<c:url value='/resources/img/biz/slider/gsretail_slide.jpg'/>" ></li>
			         <li><img src="<c:url value='/resources/img/biz/slider/note3_slider.jpg'/>"></li></ul>
	      
<script class="secret-source">
	$(document).ready(function($) {
	
	    $('#gsretail_slider').bjqs({
	      height      : 320,
	      width       : 1024,
	      responsive  : true
